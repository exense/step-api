...
public @interface Keyword {
    ...
    String ROUTING_EXECUTE_ON_CONTROLLER = "controller";
	/**
	 ...
	 *     <li>{@link #ROUTING_EXECUTE_ON_CONTROLLER}: execute the keyword directly on the controller rather than on agents</li>
